...
def trata_datas(elemento):
    """
    Recebe um dicionario e cria um campo com ANO-MES
...
def chave_uf(elemento):
    """
    Receber dicionario
    Retornat tupla com o estado (UF) e o elemento (UF, dicionario)
    """
    chave = elemento['uf']
...
def casos_dengue(elemento):
    """
    Recebe uma tupla ('RS', [{},{}])
    Retornar uma tupla ('RS-2014-01', 8.0)
    """
...
def arredonda(elemento):
    """
    Recebe tupla 
    Retorna tupla com valor arredondado
    """
    chave, mm = elemento
...
def filtra_campos_vazios(elemento):
    ...
    Receber tupla ('CE-2015-12', {'chuvas': [7.6], 'dengue': [29.0]})
    Retorna a tupla sem campos vazios ('CE-2015-12', {'chuvas': [7.6], 'dengue': [29.0]})
    """
...
def descompactar_elementos(elem):
    """
    Receber tupla ('CE-2015-12', {'chuvas': [7.6], 'dengue': [29.0]})
    Retornar tupla ('CE', 2015, 12, 7.6, 29.0)
    """
    chave, dados = elem
...
def preparar_csv(elem, delimitador=';'):
    """
    Receber uma tupla ('CE', '2015', '07', 38.0, 242.0)
    Retornar uma string delimitada "CE;2015;07;38.0;242.0"
    """
...
| "Soma de casos pela chave" >> beam.CombinePerKey(sum)
)
...
| "Soma de mm de chuva pela chave" >> beam.CombinePerKey(sum)
| "Arredondar resultados de chuva" >> beam.Map(arredonda)
)
...
resultado = (
    ...
    | "Filtrar campos vazios" >> beam.Filter(filtra_campos_vazios)
